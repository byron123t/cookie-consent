...
async def _extract_cookie_list(pref_menu_el):  # current_cookie_category
    ...
    for vendor_host_el in vendor_host_els:
        vendor_host = {}
        # TODO: duration may be omitted, remove if 1 item does not have it.
        ...
        # print(extract_vendor_value('Name', cookie_name.text_content())
        # cookie_host = await vendor_host.wait_for_selector('.cookie-host-container', state='attached', timeout=3000)
        # print(await cookie_host.text_content())
    return vendor_hosts
