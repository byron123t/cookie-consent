# -*- coding: utf-8 -*-
# From https://github.com/LucaCappelletti94/compress_json/blob/master/compress_json/compress_json.py
"""
...
def load(path: Union[str, Path], compression_kwargs: Dict = None, json_kwargs: Dict = None):
    ...
    if not isinstance(path, str) and not isinstance(path, Path):
        raise ValueError("The given path is not a string or Path.")
    ...
    if compression is None or compression in "json":
