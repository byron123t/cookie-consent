...
from consent.util.default_path import create_data_dir2
...
def get_out_root_dir(exper_date, consent):
...
async def kernel(exper_date: str, site: str, url: str, consent: bool, overwrite: bool, proxy_url: str, location: str):
    ...
    out_dir: Path = get_out_root_dir(exper_date, consent) / site
